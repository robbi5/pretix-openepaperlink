...
@receiver(nav_event_settings, dispatch_uid="pretix_seekink_nav_event_settings")
    ...
    return [
        {
            ...
            "active": url.namespace == "plugins:pretix_seekink"
            and url.url_name == "settings",
        }
    ]


@receiver(checkin_created, dispatch_uid="pretix_seekink_checkin_created")
def checkin_created(sender, checkin, **kwargs):
    if not sender.settings.get("seekink_push_badges", as_type=bool, default=False):
        return
...
settings_hierarkey.add_default("seekink_push_badges", False, bool)
